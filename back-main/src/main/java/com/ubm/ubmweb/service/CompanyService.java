...
public class CompanyService {
    ...
    @Transactional(readOnly = true)
    public Company getCompanyByIdIfUserAssociated(UUID companyId, UUID userId) {
    ...
    @Transactional
    public Company createCompany(UUID userId, CompanyInput data) {
    ...
    @Transactional
    public Company updateCompany(UUID companyId, UUID userId, CompanyInput data) {
        boolean isAssociated = userCompanyRelationshipRepository.existsById(new UserCompanyId(companyId, userId));
