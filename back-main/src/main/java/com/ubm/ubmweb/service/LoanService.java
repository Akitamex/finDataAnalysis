...
public class LoanService {
    ...
    @Transactional
    public Loan createLoan(UUID userId, CreateLoanInput input) {
        ...
        List<LoanPayment> paymentSchedule = this.generatePaymentSchedule(loan);
    ...
    @Transactional
    public Loan updateLoan(UUID userId, UpdateLoanInput input) {
    ...
    @Transactional
    public void deleteLoan(UUID userId, UUID companyId, UUID id) {
    ...
    @Transactional
    public void applyOperationAsPayment(UUID userId, UUID loanPaymentId, UUID operationId) {
    ...
    @Transactional
    public void removeOperationFromPayment(UUID userId, UUID operationId) {
        Operation operation = operationsRepository.findById(operationId)
            .orElseThrow(() -> new RuntimeException("Operation not found with id " + operationId));
    ...
    public List<Loan> findLoans(UUID userId, UUID companyId, String name) {
        boolean isAssociated = userCompanyRelationshipRepository.existsById(new UserCompanyId(companyId, userId));
        if(!isAssociated){
    ...
    @Transactional(readOnly = true)
    public Loan findLoanById(UUID userId, UUID companyId, UUID loanId) {
