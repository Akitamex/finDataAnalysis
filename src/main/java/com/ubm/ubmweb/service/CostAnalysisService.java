...
public class CostAnalysisService{
    ...
    public CostAnalysis costAnalysis(UUID companyId, UUID userId, String timeframe, String grouping, List<UUID> bankAccountIds, List<UUID> projectIds, List<UUID> articleIds){
