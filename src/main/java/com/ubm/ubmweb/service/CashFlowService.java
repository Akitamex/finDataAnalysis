...
public class CashFlowService{
    ...
    public CashFlow cashFlow(UUID companyId, UUID userId, String type, String timeframe, String grouping, List<UUID> bankAccountIds, List<UUID> projectIds){
        ...
        List<Operation> incomeOperations = operationsService.findOperations(companyId, userId, dateRange, Collections.emptyList(), 
        ...
        List<Operation> expenseOperations = operationsService.findOperations(companyId, userId, dateRange, Collections.emptyList(), 
                Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), projectIds,
                Collections.emptyList(), List.of("EXPENSE"), Collections.emptyList(), bankAccountIds, null);
        List<Operation> transferOperations = operationsService.findOperations(companyId, userId, null, Collections.emptyList(), 
                Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), projectIds,
                Collections.emptyList(), List.of("TRANSFER"), Collections.emptyList(), null, null);
        List<Operation> inOperations = operationsService.findOperations(companyId, userId, null, Collections.emptyList(), 
                Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), projectIds,
                Collections.emptyList(), List.of("INCOME"), Collections.emptyList(), bankAccountIds, null);
        List<Operation> exOperations = operationsService.findOperations(companyId, userId, null, Collections.emptyList(), 
                Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), projectIds,
                Collections.emptyList(), List.of("EXPENSE"), Collections.emptyList(), bankAccountIds, null);
        ...
        List<BankAccount> bankAccounts = bankAccountService.findBankAccounts(companyId, userId, null, null, null, null, null, null, null, Collections.emptyList(),bankAccountIds);
