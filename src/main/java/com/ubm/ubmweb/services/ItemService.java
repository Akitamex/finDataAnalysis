package com.ubm.ubmweb.services;                //Товарные запасы
...
public class ItemService {
    ...
    @Transactional
    public Item updateItem(UpdateItemInput itemDetails, Long userId) {
    ...
    @Transactional
    public void deleteItem(Long id, Long userId, Long companyId) {
    ...
    public List<Item> findItems(Long userId, Long companyId, String name, List<String> types, String description) {
        boolean isAssociated = userCompanyRelationshipRepository.existsById(new UserCompanyId(companyId, userId));
        if (!isAssociated){
            throw new UnauthorizedAccessException("User does not have access to update this company.");
        }
    ...
    @Transactional(readOnly = true)
    public Item getItemById(Long userId, Long id, Long companyId) {
        boolean isAssociated = userCompanyRelationshipRepository.existsById(new UserCompanyId(companyId, userId));
        if (!isAssociated){
            throw new UnauthorizedAccessException("User does not have access to update this company.");
        }
